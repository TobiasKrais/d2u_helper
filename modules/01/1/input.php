...
<div class="row">
	...
	<div class="col-xs-12">
		<textarea name="REX_INPUT_VALUE[3]" class="form-control <?= \FriendsOfRedaxo\D2UHelper\BackendHelper::getWYSIWYGEditorClass() ?>" style="height: 500px">REX_VALUE[3]</textarea>
	</div>
</div>
<script>
