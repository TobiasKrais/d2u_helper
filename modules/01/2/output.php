<?php
/* d2u_translate: 1:text, 2:html, 11:html */
		...
		<div class="row">
			<?php
                ...
                if ($show_text_2 && '' !== $text_2) { /** @phpstan-ignore-line */
                    ...
                    echo '<button id="button_'. $id .'" class="text-toggler angle-down" type="button">'. rex_escape($more) .'</button>';
                    ...
                    echo 'document.addEventListener("DOMContentLoaded", function () {'. PHP_EOL;
                        ...
                        echo 'button.addEventListener("click", function () {'. PHP_EOL;
                            ...
                            echo 'button.textContent = isOpen ? "'. rex_escape($less, 'js') .'" : "'. rex_escape($more, 'js') .'";'. PHP_EOL;
