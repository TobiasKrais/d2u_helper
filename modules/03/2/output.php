		...
		<?php
			foreach($pics as $pic) {
				...
				if($media instanceof rex_media) {
		            ...
		            print '<img src="'. ($number_pics == 1 ? rex_url::media($pic) : 'index.php?rex_media_type='. $type_thumb .'&rex_media_file='. $pic) .'" class="img-fluid gallery-pic-box"'
