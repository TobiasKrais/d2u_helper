...
?>
	...
	<script>
		...
		document.getElementById('map-<?= $map_id ?>').addEventListener('click', function() {
			...
			script.src = <?= json_encode('https://maps.googleapis.com/maps/api/js' . $api_key, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;
			script.onload = function() {
				// Remove hint
				var g = document.getElementById('maps-gdpr-hint-<?= $map_id ?>');
				g.outerHTML = '';
