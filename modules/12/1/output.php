	...
	<div class="row">
		<?php
            foreach ($items as $item) {
                ...
                $footerHtml = '<a href="'. rex_escape($itemUrl, 'html_attr') .'" target="_blank" title="'. rex_escape($itemTitle, 'html_attr') .'">'. rex_escape($itemTitle) .'</a>';
                echo '<a href="'. rex_escape($link_url, 'html_attr') .'" data-toggle="lightbox'. (int) $lightbox_id .'" data-gallery="example-gallery'. (int) $lightbox_id .'" class="'. rex_escape($pics_cols, 'html_attr') .'" data-title="'. rex_escape($streamTitle, 'html_attr') .'" title="'. rex_escape($streamTitle, 'html_attr') .'" data-footer="'. rex_escape($footerHtml, 'html_attr') .'">';
