...
<div class="row">
	<div class="col-xs-12">
		<p>Zu beachten:</p>
		<ul>
			<li>Überschriften der Ebene 1 werden nicht im Inhaltsverzeichnis ausgegeben, da hiervon nur eine einzige existieren sollte.</li>
			<li>Die erste Überschrift nach der sollte eine Überschrift der Ebene 2 sein, damit die Unterebenen korrekt dargestellt werden.</li>
		</ul>
	</div>
</div>