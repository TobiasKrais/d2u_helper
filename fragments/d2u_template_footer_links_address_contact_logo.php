	...
	<?php
                ...
                echo '<div class="col-12">';
                    echo '<div class="footer-address">';
                        ...
                        foreach ($rex_articles as $rex_article) {
                            echo '<a href="'. $rex_article->getUrl() .'"><span class="fa-icon fa-link footer-icon"></span>'. rex_escape((string) $rex_article->getName()) .'</a><br>';
                        }
        ...
        echo '<div class="col-12 col-md-4">';
            ...
            if ('' !== (string) $d2u_helper->getConfig('footer_text_street', '')) {
                echo '<span class="fa-icon fa-home footer-icon"></span>'. rex_escape((string) $d2u_helper->getConfig('footer_text_street')) .'<br>';
            }
        ...
        if ($media_logo_footer instanceof rex_media) {
            ...
            echo '<a href="'. rex_getUrl(rex_article::getSiteStartArticleId()) .'">'
                .'<img src="'. TobiasKrais\D2UHelper\FrontendHelper::getMediaUrl($media_logo_footer->getFileName()) .'" alt="'. rex_escape((string) $media_logo_footer->getTitle(), 'html_attr') .'" title="'. rex_escape((string) $media_logo_footer->getTitle(), 'html_attr') .'" id="logo-footer" loading="lazy">'
                .'</a>';
            echo '</div>';
        }
    ?>
