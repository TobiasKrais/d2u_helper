	...
	<?php
        ...
        if ($media_logo_footer instanceof rex_media) {
            ...
            echo '<a href="'. rex_getUrl(rex_article::getSiteStartArticleId()) .'">'
                .'<img src="'. TobiasKrais\D2UHelper\FrontendHelper::getMediaUrl($media_logo_footer->getFileName()) .'" alt="'. $media_logo_footer->getTitle() .'" title="'. $media_logo_footer->getTitle() .'" id="logo-footer" loading="lazy">'
                .'</a>';
            echo '</div>';
        }
    ?>
