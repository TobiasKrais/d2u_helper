	...
	<?php
        ...
        if ('' !== (string) $d2u_helper->getConfig('footer_logo', '')) {
                ...
                if ($media_logo instanceof rex_media) {
                    echo '<img src="'. TobiasKrais\D2UHelper\FrontendHelper::getMediaUrl((string) $d2u_helper->getConfig('footer_logo')) .'" alt="'. rex_escape((string) $media_logo->getTitle(), 'html_attr') .'" title="'. rex_escape((string) $media_logo->getTitle(), 'html_attr') .'" id="logo-footer" class="img-fluid" loading="lazy">';
                }
                echo '</a>';
        }
        echo '</div>';
