	...
	<?php
        ...
        if ('' !== (string) $d2u_helper->getConfig('footer_facebook_link', '')) {
            echo '<div class="footerbox">';
                ...
                echo '<a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_facebook_link')), 'html_attr') .'" target="_blank">'. \Sprog\Wildcard::get('d2u_helper_social_facebook') .'</a>';
            echo '</div>';
        }
        // Google link
        if ('' !== (string) $d2u_helper->getConfig('footer_google_link', '')) {
            echo '<div class="footerbox">';
                ...
                echo '<a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_google_link')), 'html_attr') .'" target="_blank">'. \Sprog\Wildcard::get('d2u_helper_social_google') .'</a>';
            echo '</div>';
        }
        // Instagram link
        if ('' !== (string) $d2u_helper->getConfig('footer_instagram_link', '')) {
            echo '<div class="footerbox">';
                ...
                echo '<a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_instagram_link')), 'html_attr') .'" target="_blank">'. \Sprog\Wildcard::get('d2u_helper_social_instagram') .'</a>';
            echo '</div>';
        }
        // LinkedIn link
        if ('' !== (string) $d2u_helper->getConfig('footer_linkedin_link', '')) {
            echo '<div class="footerbox">';
                ...
                echo '<a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_linkedin_link')), 'html_attr') .'" target="_blank">'. \Sprog\Wildcard::get('d2u_helper_social_linkedin') .'</a>';
            echo '</div>';
        }
        // Youtube link
        if ('' !== (string) $d2u_helper->getConfig('footer_youtube_link', '')) {
            echo '<div class="footerbox">';
                ...
                echo '<a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_youtube_link')), 'html_attr') .'" target="_blank">'. \Sprog\Wildcard::get('d2u_helper_social_youtube') .'</a>';
            echo '</div>';
        }
        echo '</div>';
