            ...
            if ('' !== (string) $d2u_helper->getConfig('cta_box_article_ids', '')) {
                foreach (explode(',', (string) $d2u_helper->getConfig('cta_box_article_ids', '')) as $article_id) {
                    ...
                    if ($article instanceof rex_article) {
                        echo '<li><span class="cta_box_toggler fa-icon fa-link footer-icon" title="'. rex_escape((string) $article->getName(), 'html_attr') .'"></span></li>';
                    }
                }
            }
...
<div id="cta_box" class="d-print-none">
	<div id="cta_box_content">
		...
		<?php
            ...
            if ('' !== (string) $d2u_helper->getConfig('footer_text_phone', '')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-phone footer-icon" title="'. Sprog\Wildcard::get('d2u_helper_module_form_phone').'"></span><span class="cta_box_content"><a href="tel:'. rex_escape((string) $d2u_helper->getConfig('footer_text_phone'), 'html_attr') .'">'. rex_escape((string) $d2u_helper->getConfig('footer_text_phone')) .'</a></span></li>';
            }
            if ('' !== (string) $d2u_helper->getConfig('footer_text_mobile', '')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-mobile-alt footer-icon" title="'. Sprog\Wildcard::get('d2u_helper_module_form_phone').'"></span><span class="cta_box_content"><a href="tel:'. rex_escape((string) $d2u_helper->getConfig('footer_text_mobile'), 'html_attr') .'">'. rex_escape((string) $d2u_helper->getConfig('footer_text_mobile')) .'</a></span></li>';
            }
            if ('' !== (string) $d2u_helper->getConfig('footer_text_fax', '')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-fax footer-icon"></span><span class="cta_box_content">'. rex_escape((string) $d2u_helper->getConfig('footer_text_fax')) .'</span></li>';
            }
            if ('' !== (string) $d2u_helper->getConfig('cta_box_article_ids', '')) {
                foreach (explode(',', (string) $d2u_helper->getConfig('cta_box_article_ids', '')) as $article_id) {
                    $article = rex_article::get((int) $article_id);
                    if ($article instanceof rex_article) {
                        echo '<li><span class="cta_box_toggler fa-icon fa-link footer-icon" title="'. rex_escape((string) $article->getName(), 'html_attr') .'"></span><span class="cta_box_content"><a href="'. rex_getUrl($article_id) .'">'. rex_escape((string) $article->getName()) .'</a></span></li>';
                    }
                }
            }
            if ('' !== (string) $d2u_helper->getConfig('footer_facebook_link', '')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-facebook footer-icon" title="'. Sprog\Wildcard::get('d2u_helper_social_facebook') .'"></span><span class="cta_box_content"><a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_facebook_link')), 'html_attr') .'" target="_blank">'. Sprog\Wildcard::get('d2u_helper_social_facebook') .'</a></span></li>';
            }
            // Google link
            if ('' !== (string) $d2u_helper->getConfig('footer_google_link', '')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-google footer-icon" title="'. Sprog\Wildcard::get('d2u_helper_social_google') .'"></span><span class="cta_box_content"><a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_google_link')), 'html_attr') .'" target="_blank">'. Sprog\Wildcard::get('d2u_helper_social_google') .'</a></span></li>';
            }
            // Instagram link
            if ('' !== (string) $d2u_helper->getConfig('footer_instagram_link', '')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-instagram footer-icon" title="'. Sprog\Wildcard::get('d2u_helper_social_instagram') .'"></span><span class="cta_box_content"><a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_instagram_link')), 'html_attr') .'" target="_blank">'. Sprog\Wildcard::get('d2u_helper_social_instagram') .'</a></span></li>';
            }
            // LinkedIn link
            if ('' !== (string) $d2u_helper->getConfig('footer_linkedin_link', '')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-linkedin footer-icon" title="'. Sprog\Wildcard::get('d2u_helper_social_linkedin') .'"></span><span class="cta_box_content"><a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_linkedin_link')), 'html_attr') .'" target="_blank">'. Sprog\Wildcard::get('d2u_helper_social_linkedin') .'</a></span></li>';
            }
            // Youtube link
            if ('' !== (string) $d2u_helper->getConfig('footer_youtube_link')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-youtube footer-icon" title="'. Sprog\Wildcard::get('d2u_helper_social_youtube') .'"></span><span class="cta_box_content"><a href="'. rex_escape(\TobiasKrais\D2UHelper\FrontendHelper::sanitizeUrl((string) $d2u_helper->getConfig('footer_youtube_link')), 'html_attr') .'" target="_blank">'. Sprog\Wildcard::get('d2u_helper_social_youtube') .'</a></span></li>';
            }
            if ('' !== (string) $d2u_helper->getConfig('footer_text_email', '')) {
                echo '<li><span class="cta_box_toggler fa-icon fa-envelope footer-icon" title="'. Sprog\Wildcard::get('d2u_helper_module_form_email') .'"></span>'
                    . '<span class="cta_box_content"><a href="mailto:'. rex_escape((string) $d2u_helper->getConfig('footer_text_email'), 'html_attr') .'">'. rex_escape((string) $d2u_helper->getConfig('footer_text_email')) .'</a></span></li>';
            }
        ?>
		</ul>
	</div>
