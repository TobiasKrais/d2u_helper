...
if ('save' === filter_input(INPUT_POST, 'btn_save')) {
    ...
    $settings['template_logo_dark'] = $input_media['template_logo_dark'] ?? '';
				...
				<div class="panel-body-wrapper slide">
					...
					<?php
                        ...
                        foreach ($d2u_templates as $d2u_template) {
                            ...
                            $d2u_template_ids_for_settings = ['02-1', '02-2', '03-1', '03-2', '03-3', '03-4', '04-1', '04-2', '04-3', '04-4', '05-1', '05-2'];
                            if (in_array($d2u_template->getD2UId(), $d2u_template_ids_for_settings, true) && $d2u_template->isInstalled()) {
                                ...
                                if (in_array($d2u_template->getD2UId(), ['02-1', '02-2', '04-3', '04-4'], true)) {
                                    $navi_pos_options = [
