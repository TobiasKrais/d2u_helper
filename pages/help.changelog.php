<div class="panel panel-edit">
	...
	<div class="panel-body">
		<p>2.3.0</p>
		<ul>
			<li>Übersetzungshilfe „Redaxo Artikel Inhalte" (umbenannt): Die Artikel werden jetzt als Tabelle mit Struktur-Einrückung dargestellt (übergeordnete Ebenen immer sichtbar, Artikelnamen verlinkt). Eigene Spalten zeigen den Status je Artikel — ohne Inhalt, fehlende Blöcke, zu aktualisierende Blöcke. Pro Artikel gibt es drei Aktionen: kompletten Inhalt aus der Ausgangssprache kopieren und übersetzen, nur fehlende Blöcke ergänzen und übersetzen, oder nur veraltete Blöcke aktualisieren und übersetzen. Der bisherige Status-Filter entfällt (die Information steht jetzt in den Spalten).</li>
