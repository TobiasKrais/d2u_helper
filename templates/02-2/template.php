...
<head>
	<?php
        ...
        echo '<link rel="stylesheet" type="text/css" href="'. TobiasKrais\D2UHelper\FrontendHelper::getTemplateAssetUrl('02-2', 'template.css') .'">';
					...
					<?php
                        if ($d2u_helper->hasConfig('template_header_pic') && '' !== $d2u_helper->getConfig('template_header_pic')) {
                            ...
                            if ($media_header_pic instanceof rex_media) {
                                echo TobiasKrais\D2UHelper\FrontendHelper::getHeaderPictureTag($header_image, $media_header_pic->getTitle(), $media_header_pic->getTitle(), 'id="header" width="1200px"');
                            }
                        }
                    ?>
				</div>
