				...
				<div class="col-12">
					<?php
                        if ($d2u_helper->hasConfig('template_03_2_header_pic') || '' !== $d2u_helper->getConfig('template_03_2_header_pic')) {
                            ...
                            echo TobiasKrais\D2UHelper\FrontendHelper::getHeaderPictureTag($header_image);
                        }
                    ?>
				</div>
			</div>
				...
				<div class="col-12">
					<?php
                        ...
                        if ($d2u_helper->hasConfig('template_03_2_time_show_ad') && $d2u_helper->getConfig('template_03_2_time_show_ad') > 0) {
                            $interval = ' data-bs-interval="'. $d2u_helper->getConfig('template_03_2_time_show_ad') .'000"';
                        }
                    ?>

					<div id="immo_advertising" class="carousel slide" data-bs-ride="carousel"<?= $interval ?> data-bs-wrap="true">
