...
class FeedDate {
	 ...
	 */
	function __construct($dateString = 0) {
...
class MBOXCreator extends FeedCreator {
	...
	function createFeed() {
		for ($i=0;$i<count($this->items);$i++) {
			...
			$feed.= "From: \"".MBOXCreator::qp_enc($from)."\"". PHP_EOL;
			$feed.= "Date: ".$itemDate->rfc822() . PHP_EOL;
			$feed.= "Subject: ".MBOXCreator::qp_enc(FeedCreator::iTrunc($this->items[$i]->title,100)) . PHP_EOL . PHP_EOL;
...
$rdfValidFeedTypes = array ("RSS0.91", "RSS1.0", "RSS2.0", "OPML", "ATOM", "ATOM0.3");
