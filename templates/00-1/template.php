				...
				<div class="col-12 subhead-nav">
					<?php
						if($machine !== false) {
							...
							if(rex_plugin::get("d2u_machinery", "machine_agitator_extension")->isAvailable() && $machine->agitator_type_id > 0 && $machine->category instanceof Category && $machine->category->show_agitators === "show") {
