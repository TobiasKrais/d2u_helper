...
<head>
	<?php
		...
		echo '<link rel="stylesheet" type="text/css" href="'. TobiasKrais\D2UHelper\FrontendHelper::getTemplateAssetUrl('01-2', 'template.css') .'">';
				...
				<div class="col-12 col-md-6">
					<?php
                        ...
                        if ($media_header_pic instanceof rex_media) {
							echo TobiasKrais\D2UHelper\FrontendHelper::getHeaderPictureTag($header_image, $media_header_pic->getTitle(), $media_header_pic->getTitle(), 'id="logo"');
                        }
                    ?>
				</div>
				<div class="col-12 col-md-6">
