...
class d2u_helper_lang_helper extends \D2U_Helper\ALangHelper {
	...
	protected $replacements_dutch = [
		...
		'd2u_helper_consent_manager_cookies_googleanalytics_cookie_ga' => 'Slaat een anonieme ID op voor elke bezoeker van de website. Op basis van de ID kunnen paginaweergaven worden toegewezen aan een bezoeker.',
		'd2u_helper_consent_manager_cookies_googleanalytics_cookie_gat' => 'Voorkomt dat gegevens te snel naar de Analytics Server worden verzonden.',
		'd2u_helper_consent_manager_cookies_googleanalytics_cookie_gid' => 'Slaat een anonieme ID op voor elke bezoeker van de website. Op basis van de ID kunnen paginaweergaven worden toegewezen aan een bezoeker.',
		'd2u_helper_consent_manager_cookies_googleanalytics_name' => 'Google Analytics',
	...
	protected $replacements_russian = [
		...
		'd2u_helper_module_form_validate_name' => 'Введите свое полное имя',
